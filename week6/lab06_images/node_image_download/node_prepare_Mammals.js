...
// our search term
const search =  `World of Mammals AND Exhibition Hall unit_code:"SIA" AND online_media_type:"Images"`;
...
setTimeout(() => {
    fs.writeFileSync('./eyes_mammals_data.json', JSON.stringify(myArray), 'utf8')
}, 5000)
